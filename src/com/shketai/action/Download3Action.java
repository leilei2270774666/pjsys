...
public class Download3Action extends ActionSupport {
	...
	public void download3() throws IOException, WriteException, ClassCastException {
		...
		info =subjectrefundService.getSubjectrefund();
		int i = 2;
		for (Object[] infos : info) {
			String Stuname =infos[0].toString();
			wsheet.addCell(new Label(0, i, Stuname,wcf_left));
			wsheet.addCell(new Label(1, i,infos[1].toString(),wcf_left));
			/*wsheet.addCell(new Label(2, i, object[2].toString()));
			wsheet.addCell(new Label(3, i, object[3].toString()));*/
