...
import com.shketai.util.CompressedFileUtil;

public class DownloadInfoAction  extends ActionSupport{
	...
	private void writeDataExcel(XSSFWorkbook wb,XSSFSheet sheet, List<Object[]> info) throws Exception {
		...
		for (int i = 0; i < info.size(); i++)  {
		    ...
		    cell = row.createCell(2);
//		     查询班级id  返回 班主任对象
		    HeadMaster headMaster = headMasterService.sqlQueryclassinfo_id(Integer.parseInt(array[15].toString()));
		    if(headMaster != null) {
		    ...
		    cell = row.createCell(15);
		    cell.setCellValue(array[14].toString());
		}
